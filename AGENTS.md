...
**Goal:** Production-ready AI Weather Assistant
...
- Provides accurate weather information for any location worldwide
- Helps users plan activities based on current weather conditions
- Uses the Open-Meteo API for real-time weather data
- Maintains conversation context through Mastra's memory system
- Fully tested with Scenario simulation-based testing
- All prompts managed through LangWatch Prompt CLI

**Agent capabilities:**
1. Weather lookup by city name (supports any location globally)
2. Activity suggestions based on weather conditions
3. Multi-turn conversations with context retention
4. Automatic location geocoding and translation
